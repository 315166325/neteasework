package com.netease.work.controller;

import com.netease.work.Model.HostHolder;
import com.netease.work.pojo.*;
...
public class ItemController {
    ...
    public void deleteItem(Model model, @RequestParam("id") int id, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) {
        try {
