...
<div class="g-doc">
    ...
    <table class="m-table m-table-row n-table g-b3">
        ...
        <tr>
            <th>内容图片</th>
            <th>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp内容名称</th>
            <th>&nbsp&nbsp&nbsp&nbsp&nbsp购买时间</th>
            <th>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp购买数量</th>
            <th>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp购买价格</th>
        </tr>
        </thead>
        <tbody>
        <c:forEach var="item" items="${result}">
            <tr>
                ...
                <td><h4><a href="/show?id=${item.gid}">${item.title}</a></h4></td>
